                ...
                fluidRow(
                  ...
                  conditionalPanel(
                    ...
                    box(width=12,title = "Clan summary",
                        div(p("For game results and standings, see the ", a("spreadsheet", href="https://docs.google.com/spreadsheets/d/1mu0Ln46r2vjL9vdYZTnWXqbh9pZliJP_FJsK-yZdyOQ", target = "_blank"))),
