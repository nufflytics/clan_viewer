                ...
                fluidRow(
                  ...
                  conditionalPanel(
                    ...
                    box(width=12,title = "Clan summary",
                        div(p("For game results and standings, see the ", a("spreadsheet", href="https://docs.google.com/spreadsheets/d/1WkEi6eH8Ljzx0rsBY0mZoS7k4YgEjZe5KTDpNFqiN4A", target = "_blank"))),
